          ...
          <div className="absolute inset-0 flex  justify-center text-black p-20 overflow-y-auto no-scrollbar">
            <div className="text-center w-9/10 h-4/6">
              ...
              <p className="mb-2">
                ...
                thank you 🥰) If not, well my friend, you are in for some looong
                story. (I'm sorry. I promise I'm cringing as much as you are)
              </p>
              ...
              <p className="mb-2">
                ...
                rebelled to get a computer becuase he wanted one to study ICT in
                his school. IDK whether he actually did any study from it but I
                got to play with it when many other kids in our neighbourhood
                didn't have one. I played video games on it and I started buying
                Vijaya Computer magazine every month.(I still have that
                collection btw) Well that might be misleading tho cuz I actually
                read all kind of stuff back then. By age 9 I finished reading
                every single book in our house. And that included my brother's
                school textbooks. Because of that I even had a chance to
                participate in international junior science olympiad in 2011 and
                2012 in Philliphines and India.
              </p>
              ...
              <div className="mb-2">
                ...
                was I. So I had to start working again. I think I might be able
                to pull through with a first class at this rate. In the meantime
                I learned some stuff about programming, algorithms and some
                machine learning. So here we are.
              </div>
              ...
              {/* Skills Section */}
              <div className="mb-8">
                <h4 className="text-2xl font-bold mb-4 underline">Skills</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h5 className="text-xl font-bold mb-2">Technical Fields</h5>
                    <p>
                  ...
                  <div>
                    <h5 className="text-xl font-bold mb-2">Tools & Services</h5>
              ...
              <h3 className="text-4xl font-semibold mb-4">About this site</h3>
              <p className="mb-2">
                I found that other people are making these things and thought
                about making one. But then I was like, "Nah, this whole thing is
                stupid". Because if I'm going to use a template, what purpose
                does it serve? You know it's a template. I know it's a template.
                So why bother? And I'm not that good enough to build a
                interesting one myself. But then it occured to me that I could
                play this angle. I could make a shit site and pretend that it is
                good. So I whipped this bad boy in like 3 days. It took more
                time than I thought because it never is that simple. But yeah.
                And I know there is shit ton of bugs that I'm too lazy to fix.
                So have fun with them as well.
              </p>
              <div className="h-10" />
            </div>
          </div>
