                                    ...
                                    {currentProjectIndex === 0 && (
                                        <div className="flex flex-col md:flex-row items-center md:items-center gap-8">
                                            ...
                                            <div className="w-full md:w-1/2">
                                                ...
                                                <p>
                                                    <strong>Tech Stack:</strong> Tianshou, Python,
                                                    MetaTrader 5
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    {currentProjectIndex === 2 && (
                                        <div className="flex flex-col md:flex-row items-center md:items-center gap-8">
                                            ...
                                            <div className="w-full md:w-1/2">
                                                ...
                                                <p>
                                                    <strong>Tech Stack:</strong> React, Android Studio,
                                                    Firebase
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col md:flex-row items-center md:items-center gap-8">
                                            ...
                                            <div className="w-full md:w-1/2">
                                                ...
                                                <p className="mb-4">
                                                    ...
                                                    full stack application development. I think that might
                                                    be obvious looking at the login page. (Well I guess
                                                    this page doesn't look that good too so nothing may
                                                    have changed) So it was pretty challenging at that
                                                    time and we almost gave up on it. But like week before
                                                    deadline, I tried connecting my backend to the
